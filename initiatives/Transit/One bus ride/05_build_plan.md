...
- [ ] `initiatives/Transit/ideas.md` — row updated through Checkpoint A, **Next:** Task 3.
...
- [ ] `initiatives/Transit/ideas.md` — row updated through Checkpoint B, **Next:** Evaluation.
- [ ] `wiki/log.md` — updated if wiki changed.
