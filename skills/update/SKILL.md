...
3. **Project-scoped:** under each project folder: `initiatives/[Initiative]/*/sources/` (exclude `wiki/`; project names are the direct child folder names of the initiative, per `SYSTEM_OVERVIEW.md`).
